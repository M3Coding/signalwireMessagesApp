...
import { AllOrNone, ChatJSONRPCMethod, MessagingJSONRPCMethod, VoiceCallMethod, ClientContextMethod } from '..';
 ...
 */
export type FabricMethod = 'call.mute' | 'call.unmute' | 'call.deaf' | 'call.undeaf' | 'call.layout.list' | 'call.member.list' | 'call.member.remove' | 'call.member.position.set' | 'call.layout.set' | 'call.microphone.volume.set' | 'call.microphone.sensitivity.set' | 'call.speaker.volume.set' | 'call.lock' | 'call.unlock' | 'call.raisehand' | 'call.lowerhand' | 'call.audioflags.set';
...
export type UpdateMediaDirection = 'sendonly' | 'recvonly' | 'sendrecv' | 'inactive';
