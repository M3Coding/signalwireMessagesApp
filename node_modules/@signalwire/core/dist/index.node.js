...
__export(index_exports, {
  ...
  FABRIC_MEMBER_UPDATABLE_PROPS: () => FABRIC_MEMBER_UPDATABLE_PROPS,
  FABRIC_MEMBER_UPDATED_EVENTS: () => FABRIC_MEMBER_UPDATED_EVENTS,
  GLOBAL_VIDEO_EVENTS: () => GLOBAL_VIDEO_EVENTS,
  HttpError: () => HttpError,
  INTERNAL_FABRIC_MEMBER_UPDATABLE_PROPS: () => INTERNAL_FABRIC_MEMBER_UPDATABLE_PROPS,
  INTERNAL_FABRIC_MEMBER_UPDATED_EVENTS: () => INTERNAL_FABRIC_MEMBER_UPDATED_EVENTS,
  ...
  RPCEventAckResponse: () => RPCEventAckResponse,
  ...
  SYMBOL_CONNECT_ERROR: () => SYMBOL_CONNECT_ERROR,
  SYMBOL_EXECUTE_CONNECTION_CLOSED: () => SYMBOL_EXECUTE_CONNECTION_CLOSED,
  SYMBOL_EXECUTE_TIMEOUT: () => SYMBOL_EXECUTE_TIMEOUT,
  UNIFIED_CONNECT_VERSION: () => UNIFIED_CONNECT_VERSION,
...
var asyncRetry = (_0) => __async(void 0, [_0], function* ({
  asyncCallable,
  ...
  let wait2 = 0;
  const promiseAttempt = () => __async(void 0, null, function* () {
    var _a;
    try {
      let result;
      if (wait2 <= 0) {
        result = yield asyncCallable();
      } else {
        result = yield new Promise(
...
var BaseSession = class {
  ...
  _eventAcknowledgingHandler(payload) {
    return __async(this, null, function* () {
    ...
    return __async(this, null, function* () {
      ...
      if (this.expiresIn <= this._refreshTokenNotificationDiff) {
        ...
        if (typeof refreshTokenFn === "function") {
          try {
            const token = yield refreshTokenFn();
...
function* sessionSaga({
  ...
  const sessionChannelTask = yield (0, import_effects3.fork)(sessionChannelWatcher, {
    session,
    sessionChannel,
    swEventChannel
  });
...
var rootSaga_default = (options) => {
  return function* root({
    ...
    while (true) {
      yield (0, import_effects3.take)(initAction.type);
      try {
        yield (0, import_effects3.call)(sessionSaga, __spreadProps(__spreadValues({}, options), {
          userOptions,
          channels
        }));
        break;
...
var BasePubSubConsumer = class _BasePubSubConsumer extends BaseConsumer {
  constructor(options) {
    super(options);
  ...
  subscribe(channels) {
    return __async(this, null, function* () {
      ...
      return __superGet(_BasePubSubConsumer.prototype, this, "subscribe").call(this);
    });
  }
