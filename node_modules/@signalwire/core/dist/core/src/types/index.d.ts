...
import type { JSONRPCRequest, UpdateMediaParams, UpdateMediaDirection } from '../utils/interfaces';
...
export interface EmitterContract<EventTypes extends EventEmitter.ValidEventTypes> {
    ...
    /** @internal */
    emit<E extends EventEmitter.EventNames<EventTypes>>(event: E, ...args: EventEmitter.EventArgs<EventTypes, E>): void;
}
...
export type SwEventParams = VideoAPIEvent | WebRTCMessageParams | VideoManagerEvent | ChatEvent | TaskEvent | MessagingEvent | VoiceCallEvent | SwAuthorizationStateEvent | ConversationEvent | FabricEvent;
export * from './video';
export * from './utils';
export * from './cantina';
export * from './chat';
