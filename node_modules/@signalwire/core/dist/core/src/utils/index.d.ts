...
export declare const isConnectRequest: (e: JSONRPCRequest | JSONRPCResponse) => boolean;
export declare const isVertoInvite: (e: JSONRPCRequest | JSONRPCResponse) => boolean;
