...
export declare const SYMBOL_EXECUTE_CONNECTION_CLOSED: unique symbol;
export declare const SYMBOL_EXECUTE_TIMEOUT: unique symbol;
export declare const SYMBOL_CONNECT_ERROR: unique symbol;
